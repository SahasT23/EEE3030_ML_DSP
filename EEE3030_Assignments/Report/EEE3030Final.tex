...
Code available here:\href{https://github.com/SahasT23/EEE3030_ML_DSP/tree/main/EEE3030_Assignments}{Github Link for accessing the code}
\end{abstract}
...
\textbf{Figure~\ref{fig:SpectroOutput}} shows the spectrogram clearly [1]:
...
\textbf{Results and Discussion}\\
The code outputs are shown below for verification.
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.36]{T4SNRAndPowerTermOutput.png}
...
[1] \href{https://uk.mathworks.com/help/signal/ref/spectrogram.html}{``Spectrogram using short-time Fourier transform - MATLAB spectrogram - MathWorks United Kingdom,” \textit{uk.mathworks.com}}

[2] \href{https://uk.mathworks.com/help/signal/ug/discrete-fourier-transform.html}{``Discrete Fourier Transform - MATLAB \& Simulink - MathWorks United Kingdom,'' \textit{uk.mathworks.com}}

[3] \href{https://doi.org/10.2991/iccasm.2012.361}{H. Chen and L. Wang, ``Software and Hardware Implementation of IIR Based on MatlabaAcceldsp,” \textit{Proceedings of the 2nd International Conference on Computer Application and System Modeling, 2012}}

[4] \href{https://doi.org/10.1093/imamci/15.2.185}{L. Pronzato, ``A generalized golden-section algorithm for line search,'' \textit{IMA Journal of Mathematical Control and Information}, vol. 15, no. 2, pp. 185--214, Jun. 1998}

\section{Appendix}

\href{https://github.com/SahasT23/EEE3030_ML_DSP/tree/main/EEE3030_Assignments}{Github Link for accessing the code}
